            ...
            <div className="flex justify-center items-center z-20 relative mt-20">
              ...
              <div className=" absolute flex ">
                <img
                  ...
                  alt="mobileGreenEllipse"
                />

                <div className="bg-[#13E24E] rounded-full w-[44.475px] h-[43.313px] mt-[-10px] ml-[-10px] flex justify-center items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="21"
                    height="21"
                  ...
                  >
                    <g clip-path="url(#clip0_101_634)">
                      <path
                        d="M18.8787 3.59765V3.60949L14.1601 18.7644C14.0887 19.0106 13.9417 19.2296 13.7388 19.392C13.5359 19.5544 13.2869 19.6526 13.0251 19.6732C12.9878 19.6764 12.9505 19.6779 12.9132 19.6779C12.6679 19.6787 12.4274 19.6111 12.2203 19.483C12.0131 19.355 11.8479 19.172 11.7441 18.9555L8.84891 13.003C8.82033 12.9441 8.81114 12.878 8.82261 12.8138C8.83407 12.7497 8.86563 12.6905 8.91296 12.6445L13.5553 8.12265C13.6718 8.00323 13.7358 7.84421 13.7336 7.6795C13.7315 7.51479 13.6633 7.35742 13.5437 7.24094C13.4241 7.12446 13.2625 7.05809 13.0934 7.05598C12.9243 7.05388 12.761 7.11619 12.6383 7.22965L7.98871 11.7507C7.94145 11.7968 7.88071 11.8275 7.81482 11.8387C7.74893 11.8499 7.6811 11.8409 7.62063 11.8131L1.54002 9.00775C1.30121 8.9012 1.10024 8.72803 0.962554 8.51017C0.824867 8.29231 0.75666 8.03956 0.76657 7.78393C0.779776 7.52119 0.877447 7.26913 1.04578 7.06341C1.21411 6.85768 1.44458 6.70868 1.7046 6.63748L17.2661 2.0422H17.2783C17.4998 1.98158 17.734 1.97946 17.9566 2.03605C18.1793 2.09264 18.3825 2.2059 18.5454 2.36423C18.7083 2.52255 18.8251 2.72023 18.8836 2.93698C18.9422 3.15373 18.9405 3.38175 18.8787 3.59765Z"
                        fill="white"
                      />
                    </g>
                    <defs>
                      <clipPath id="clip0_101_634">
                        <rect
                          ...
                          height="20.2129"
                          fill="white"
                          transform="translate(0.118164 0.0961914)"
                        />
                      </clipPath>
                    </defs>
                  </svg>
