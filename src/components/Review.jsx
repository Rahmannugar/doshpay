...
const Review = ({ mulish, dmSans }) => {
  ...
  return (
    <div>
      {isNonMobileScreens ? (
        <div className="mt-24 bg-[#121621] relative h-screen px-10 xl:px-16 py-24">
          <div
            style={middleDivStyle}
        ...
        <div>
          /* Ellipse 436 */ /* Ellipse 438 */ position: "absolute; width: 72px;
          height: 72px; left: 94px; top: 420px; background: #5EC4F0; filter:
          blur(70px);
        </div>
      )}
    </div>
