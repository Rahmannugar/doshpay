...
const Footer = ({ mulish, dmSans }) => {
  ...
  return (
    <div className="mt-72">
      {isNonMobileScreens ? (
        <div className="bg-[#121621] h-[990px]">
          <div className="bg-[#4818DC] h-[520px] mx-28 rounded-[28px] relative">
            ...
            <div className=" space-y-10 pt-32">
              ...
              <h1
                style={mulish}
                className="xl:text-[44px] max-w-[577px] mx-auto z-10 font-extrabold lg:text-2xl leading-[55px] text-white"
              >
                Download Doshpay Today!
              </h1>
              <p
                style={dmSans}
                className="leading-7 font-medium z-10 max-w-[675px] mx-auto text-white opacity-80"
              >
