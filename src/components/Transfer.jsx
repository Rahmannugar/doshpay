        ...
        <div className="px-10 xl:px-16 mt-36">
          ...
          <div className="mt-20 flex space-x-9 justify-between items-center 2xl:justify-center">
            <div
              ...
              className="w-[600px] h-[660px]"
            >
              <h1 style={mulish}>Fast and Secure Cash Transfer</h1>
              <p>
                Send money securely to any local bank around the clock with the
                assurance of robust encryption protecting your transactions.
              </p>

              <div
                style={transferButtonStyle}
                className="flex justify-center items-center h-[48px] w-[209px] space-x-1"
